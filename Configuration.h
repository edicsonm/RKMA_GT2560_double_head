...
#define DELTA_RADIUS (DELTA_SMOOTH_ROD_OFFSET-DELTA_EFFECTOR_OFFSET-DELTA_CARRIAGE_OFFSET-9)
...
#define ENABLE_AUTO_BED_LEVELING // Delete the comment to enable (remove // at the start of the line)
  ...
  #define X_PROBE_OFFSET_FROM_EXTRUDER -23.70
...
#define MANUAL_Z_HOME_POS 183.3 // For delta: Distance between nozzle and print surface after homing.
//#define MANUAL_Z_HOME_POS 184.8 // For delta: Distance between nozzle and print surface after homing.
